...
//jika online
//$filedir = "/source/admin/";
$filedir = getenv('file_dir');
$fileadmin = "../../source/admin/";
$filethumb = "../../source/thumb/";
...
//	'upload_dir' => '/source/',
    ...
    'upload_dir' => $filedir,
    //jika online
    //'upload_dir' => "/_www.sisteminformasi.com/source/admin/$user/",
    /*
      |--------------------------------------------------------------------------
...
//	'thumbs_base_path' => '../thumbs/',
     ...
     */
    //'access_keys' => array(),
    'access_keys' => array(@$_SESSION['rdb_sessuser']),
    //--------------------------------------------------------------------------------------------------------
